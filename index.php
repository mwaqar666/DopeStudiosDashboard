                        ...
                        <div class="card-body bg-light">
                            <div class="row text-center">
                                <div class="col-lg-4 border-right">
                                    ...
                                    <h6>My Balance</h6> <b>$14,146</b>
                                </div>
                                <div class="col-lg-4 border-right">
                                    <div id="sparkline9" class="m-b-10"></div>
                                    <h6>New Orders</h6> <b>$4567</b>
                                </div>
                                <div class="col-lg-4">
                                    <div id="sparkline10" class="m-b-10"></div>
                                    <h6>Overall Views</h6> <b>4328</b>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card earning-widget">
                    ...
                    <div class="border-top">
                        <table class="table v-middle no-border">
                            <tbody>
                                <tr>
                                    <td style="width:40px"><img src="assets/images/ClientsImgs/clientimg01.jpg" width="50" class="img-circle" alt="logo"></td>
                                    <td>Lorem Ipsum</td>
                                    <td align="right"><span class="label label-info">$2300</span></td>
                                </tr>
                                <tr>
                                    <td><img src="assets/images/ClientsImgs/clientimg02.jpg" width="50" class="img-circle" alt="logo"></td>
                                    <td>Lorem Ipsum</td>
                                    <td align="right"><span class="label label-success">$3300</span></td>
                                </tr>
                                <tr>
                                    <td><img src="assets/images/ClientsImgs/clientimg03.jpg" width="50" class="img-circle" alt="logo"></td>
                                    <td>Lorem Ipsum</td>
                                    <td align="right"><span class="label label-primary">$4300</span></td>
                                </tr>
                                <tr>
                                    <td><img src="assets/images/ClientsImgs/clientimg04.jpg" width="50" class="img-circle" alt="logo"></td>
                                    <td>Lorem Ipsum</td>
                                    <td align="right"><span class="label label-warning">$5300</span></td>
                                </tr>
                                <tr>
                                    <td><img src="assets/images/ClientsImgs/clientimg05.jpg" width="50" class="img-circle" alt="logo"></td>
                                    <td>Lorem Ipsum</td>
                                    <td align="right"><span class="label label-danger">$4567</span></td>
                                </tr>
                                <tr>
                                    <td><img src="assets/images/ClientsImgs/clientimg06.jpg" width="50" class="img-circle" alt="logo"></td>
                                    <td>Lorem Ipsum</td>
                            ...
                            <table class="table stylish-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h6>Lorem Ipsum</h6><small class="text-muted">dummy text</small>
                                        </td>
                                        <td>Lorem Ipsum</td>
