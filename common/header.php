    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <span>
                            <img src="assets/images/logo/logo-icon.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                </div>
                <div class="navbar-collapse">
                                    ...
                                    <li>
                                        <div class="message-center ps-container ps-theme-default" data-ps-id="ea183f97-7bcf-ba63-f637-df50b927166c">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="assets/images/ClientsImgs/clientimg01.jpg" alt="user" class="img-circle"> <span class="profile-status online float-right"></span> </div>
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="assets/images/ClientsImgs/clientimg02.jpg" alt="user" class="img-circle"> <span class="profile-status busy float-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="assets/images/ClientsImgs/clientimg03.jpg" alt="user" class="img-circle"> <span class="profile-status away float-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="assets/images/ClientsImgs/clientimg04.jpg" alt="user" class="img-circle"> <span class="profile-status offline float-right"></span> </div>
                                                <div class="mail-contnet">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown show">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><img src="assets/images/ClientsImgs/clientimg03.jpg" alt="user" class="img-circle" width="30"></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <span class="with-arrow"><span class="bg-primary"></span></span>
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class=""><img src="assets/images/ClientsImgs/clientimg03.jpg" alt="user" class="img-circle" width="60"></div>
                                    <div class="m-l-10">
        ...
        <aside class="left-sidebar">
            <div class="d-flex no-block nav-text-box align-items-center">
                <span> <img class="sideBarLogo" src="assets/images/favicon/favicon.png" alt=""></span>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect" href="http://localhost/DopeStudiosDashboard/">
                                <i class="fas fa-tachometer-alt"></i>
                                <span class="hide-menu">Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect" href="users.php">
                                <i class="fas fa-users"></i>
                                <span class="hide-menu">Users</span>
                            </a>
                        </li>
                        <li> <a class="waves-effect" href="music.php">
                                <i class="fas fa-music"></i>
                                <span class="hide-menu">Music</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect" href="current-bidding.php">
